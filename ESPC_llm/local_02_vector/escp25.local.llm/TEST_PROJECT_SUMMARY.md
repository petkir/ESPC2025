...
## ✅ Successfully Created: escp25.local.llm.Server.Test
...
├── escp25.local.llm.Server.Test.csproj
├── GlobalUsings.cs
├── README.md
├── Controllers/
...
```bash
cd escp25.local.llm
dotnet test escp25.local.llm.Server.Test/escp25.local.llm.Server.Test.csproj --filter "ChatModelsTests|ChatDTOsTests|ChatDbContextTests"
```

### **Build the Test Project**
```bash
dotnet build escp25.local.llm.Server.Test/escp25.local.llm.Server.Test.csproj
```
